...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_MADHKUR,        SK_SUMMONINGS,       1),
    APT(SP_MADHKUR,        SK_NECROMANCY,       2),
    APT(SP_MADHKUR,        SK_TRANSLOCATIONS,  -1),
    APT(SP_MADHKUR,        SK_TRANSMUTATIONS,  -4),
    APT(SP_MADHKUR,        SK_FIRE_MAGIC,      -1),
    APT(SP_MADHKUR,        SK_ICE_MAGIC,        1),
    APT(SP_MADHKUR,        SK_AIR_MAGIC,       -3),
    APT(SP_MADHKUR,        SK_EARTH_MAGIC,      2),
    APT(SP_MADHKUR,        SK_POISON_MAGIC,    -1),
    APT(SP_MADHKUR,        SK_INVOCATIONS,      2),
